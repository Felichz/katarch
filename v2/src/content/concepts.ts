...
<p>¿Qué decisiones merecen un ADR? No todas: las que afectan la <strong>estructura</strong>, los <strong>atributos de calidad</strong>, las <strong>dependencias</strong>, las <strong>interfaces</strong> o las técnicas de construcción; la definición que los slides oficiales de este kata toman de Nygard. Elegir el color del logo, no.</p>
...
<p>Which decisions deserve an ADR? Not all of them: the ones affecting <strong>structure</strong>, <strong>quality attributes</strong>, <strong>dependencies</strong>, <strong>interfaces</strong> or construction techniques — the definition this kata's official slides take from Nygard. Choosing the logo color, no.</p>
