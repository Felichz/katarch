...
export const EN: ArticleContent = {
  ...
  heroMeta: [
    { label: 'Case', value: 'Farmacy Food (Detroit)' },
    { label: 'Winner', value: 'ArchColider' },
    { label: 'Reading', value: '~25 minutes' },
    { label: 'Sources', value: "The teams' original repos" },
  ],
  tocTitle: 'Contents',
  sections: [
    /* ───────────────────────── 1 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Here is the information that separates a serious solution from a fantasy. The brief declared the current volume and the business targets:' },
        {
          type: 'stats',
          items: [
            { value: '2', label: 'pilot locations on day 1 (a clinic and a community center)' },
    ...
    /* ───────────────────────── 3 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Remember that fourth row: "nobody left without their meal" will return in the physical-world section — and will justify one of the most celebrated decisions in the case. That continuity — business goal → requirement → decision → ADR — is what the judges call <strong>requirements traceability</strong>, and it is the backbone of a defensible architecture.' },
    ...
    /* ───────────────────────── 6 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Fridges depend on cellular connectivity. A fridge in a hospital basement can lose signal exactly when a customer arrives to pick up an already-paid lunch. The solution: PIN codes generated in advance that the fridge validates in its local memory, without talking to the cloud. The team\u2019s documents also record the idea\u2019s evolution: they first considered generic "access codes" and discarded them as cumbersome — the 6-digit PIN tied to each meal was the final simplification. (Does the traceability row "nobody left without their meal" ring a bell? This is its destination.)' },
        ...
        { type: 'p', html: 'The repository closes its analysis with something most submissions omit: a risk list where every risk has its mitigation option written next to it. Not all are technical — several are business decisions the team explicitly marked as "to resolve with the owner". A selection:' },
        {
          type: 'list',
          items: [
        ...
        { type: 'callout', tone: 'emerald', title: 'The repeating pattern', html: 'All four solutions in this section do the same thing: <strong>accept physical reality instead of fighting it</strong>. Fridges will lose signal: design for it. Data will arrive late: design for it. Disputes will arrive: keep the evidence. Mature architecture does not eliminate the real world\u2019s problems; it is prepared when they knock.' },
      ],
    },
      ...
      blocks: [
        ...
        { type: 'p', html: 'Where do those figures come from? From something the team called <strong>volumetry</strong>: for every message traveling through the system, they noted how much it weighs and how often it happens. With that table, bandwidth and storage derive themselves — and costs stop being guesswork. The case\u2019s real values:' },
        {
          ...
          rows: [
            ...
            ['Daily dispatch to a kitchen', '20–50 kb', '1–2 per day per fridge'],
          ],
        },
