...
export const ES: ArticleContent = {
  ...
  heroMeta: [
    ...
    { label: 'Lectura', value: '~25 minutos' },
  ...
  sections: [
    /* ───────────────────────── 1 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Aquí está la información que separa una solución seria de una fantasiosa. El pliego declaraba el volumen actual y las metas del negocio:' },
        {
          type: 'stats',
          items: [
            { value: '2', label: 'locaciones piloto en el día 1 (una clínica y un centro barrial)' },
    ...
    /* ───────────────────────── 3 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Guardá la última fila del medio: "que nadie se quede sin su comida" va a volver a aparecer en la sección del mundo físico — y va a justificar una de las decisiones más celebradas del caso. Esa continuidad — objetivo de negocio → requerimiento → decisión → ADR — es lo que los jueces llaman <strong>trazabilidad de requerimientos</strong>, y es la columna vertebral de una arquitectura defendible.' },
    ...
    /* ───────────────────────── 6 ───────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'p', html: 'Las heladeras dependen de conexión celular. Una heladera en el subsuelo de un hospital puede quedarse sin señal justo cuando un cliente va a retirar su almuerzo ya pagado. La solución: códigos PIN generados por adelantado que la heladera valida en su memoria local, sin hablar con la nube. Los documentos del equipo guardan además la evolución de la idea: primero pensaron en "códigos de acceso" genéricos, y los descartaron por engorrosos — el PIN de 6 dígitos atado a cada comida fue la simplificación final. (¿Te suena la fila "que nadie se quede sin su comida" de la tabla de trazabilidad? Este es su destino.)' },
        ...
        { type: 'p', html: 'El mismo pragmatismo recorre decisiones más chicas. ¿Sincronizar campañas promocionales entre operadores con algoritmos de consistencia distribuida? Innecesario: las promociones cambian poco y las manejan <strong>en una hoja de cálculo</strong>, y el sistema solo consume el resultado final. Y todo el modelo de datos descansa sobre una observación del mundo físico: <strong>las cocinas de Detroit no ofrecen comida en Nueva York</strong>. Los datos se pueden partir por ciudad — catálogos, stock, órdenes — sin replicar casi nada entre regiones, lo que simplifica acceso, consistencia y costos de un plumazo.' },
        ...
        { type: 'p', html: 'El repositorio cierra su análisis con algo que la mayoría de las entregas omite: una lista de riesgos donde cada uno tiene su opción de mitigación escrita al lado. No todos son técnicos — varios son decisiones de negocio que el equipo marcó explícitamente como "a resolver con el dueño". Una selección:' },
        {
          type: 'list',
          items: [
      ...
      blocks: [
        ...
        { type: 'p', html: '¿De dónde salen esas cifras? De algo que el equipo llamó <strong>volumetría</strong>: para cada mensaje que viaja por el sistema, anotaron cuánto pesa y con qué frecuencia ocurre. Con esa tabla, el ancho de banda y el almacenamiento se derivan solos — y los costos dejan de ser adivinanza. Los valores reales del caso:' },
        {
          ...
          rows: [
            ...
            ['Despacho del día hacia una cocina', '20–50 kb', '1–2 por día por heladera'],
          ],
        },
